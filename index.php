...
<footer class="mt-5">
	<em>
		<h5 class="text-light text-center p-0 brand mt-2">
			...
			PUC Airlines <br>
			For More Information/Emergency Contact: ramkanto1295@gmail.com <br>
		</h5>
	</em>
	<div class="text-light text-center">&copy;
		<?php echo date('Y') ?> - Developed By Rohit,Ram<br><br>
	</div>
...
<script>
	$('.value-plus').on('click', function () {
		var divUpd = $(this).parent().find('.value'), newVal = parseInt(divUpd.text(), 1) + 1;
		divUpd.text(newVal);
